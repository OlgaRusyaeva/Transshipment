...
#ifndef TransshipmentProject_MaxILLoc_Simulator_h
#define TransshipmentProject_MaxILLoc_Simulator_h
...
class MaxILLoc_Simulator: public Simulator
{
public:
    MaxILLoc_Simulator(const int& numberOfIterations, const int& seedNumber):Simulator(numberOfIterations,seedNumber){shareToTransship=3;}
    ~MaxILLoc_Simulator(){}
