...
int __stdcall
  GRBisqp(GRBenv **, const char *, const char *, const char *, int,
          const char *);
}
...
enum GRB_IntParam {
  ...
  GRB_IntParam_Seed,
  GRB_IntParam_NonBlocking,
  GRB_IntParam_ConcurrentMIP,
  GRB_IntParam_ConcurrentMIPJobs,
...
class GRBModel
{
  ...
  public:
    ...
    //friend int returnReference(GRBModel& model);
